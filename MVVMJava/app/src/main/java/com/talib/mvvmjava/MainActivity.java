...
import com.talib.mvvmjava.databinding.ActivityMainBinding;
import com.talib.mvvmjava.model.Book;
import com.talib.mvvmjava.model.Category;
import com.talib.mvvmjava.viewmodel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadBooksArrayList(int categoryId) {
        mainActivityViewModel.getBooksOfASelectedCategory(categoryId).observe(this, books -> {
